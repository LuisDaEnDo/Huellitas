...
namespace HuellitasService.DAO
{
    public class MascotasDAO
    {
       ...
       public MascotaDTO UpdateMascota(MascotaDTO mascota)
        {
            try
            {
                using (HuellitasContext context = new HuellitasContext())
                {
                    ...
                    m.nombre = mascota.NombreMascota;
                    m.raza = mascota.RazaMascota;
                    m.tipo = mascota.TipoMascota;
                    m.color = mascota.ColorMascota;
                    m.edad = mascota.EdadMascota;
                    context.SaveChanges();
       ...
       public MascotaDTO DeleteMascota(MascotaDTO mascota)
        {
            try
            {
                using (HuellitasContext context = new HuellitasContext())
